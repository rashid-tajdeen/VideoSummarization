...
#SBATCH --output /home/rtajde2s/perl5/job_tf.%N.%j.out # filename for STDOUT (%N: nodename, %j: j$
#SBATCH --error /home/rtajde2s/perl5/job_tf.%N.%j.err  # filename for STDERR
...
# run the script
python3 main.py --frame_selection uniform --epochs 50 --classes 17 --train --valid
